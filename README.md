# R functions for regression calibration under the main study/validation study design (Authors: Wenze Tang, Molin Wang)

regCalibCRS.R: the imputation-based regression cabibration method.
